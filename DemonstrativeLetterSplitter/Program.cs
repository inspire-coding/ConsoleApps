...
static class DemonstrativeLetterSplitter
{
    ...
    public static void Split<TFunc>(TextReader reader, TFunc change) where TFunc : IFunc<char, char>
    {
    ...
    private static unsafe void Do<TFunc>(Span<char> letters, TFunc change) where TFunc : IFunc<char, char>
    {
    ...
    private static IReadOnlyDictionary<char, int> MakeLetterToIndex(ReadOnlySpan<char> letters)
    {
